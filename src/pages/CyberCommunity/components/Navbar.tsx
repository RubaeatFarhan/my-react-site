...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-[80px] left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-start h-16 md:h-20">
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg text-slate-400 hover:text-white hover:bg-white/5 transition-colors ml-auto"
          >
