            ...
            <div className="bg-white rounded-2xl shadow-2xl shadow-black/20 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-primary-600 hover:bg-primary-700 text-white font-bold text-lg py-4 rounded-xl shadow-lg shadow-primary-200 hover:shadow-xl hover:shadow-primary-300 transition-all animate-pulse-glow"
                >
                  Enroll Now
                </button>
