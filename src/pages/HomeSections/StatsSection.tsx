...
const stats = [
  { icon: <GraduationCap className="w-7 h-7" />, value: 100, suffix: '+', label: 'Students Trained', color: 'text-neon-green' },
  { icon: <ShieldCheck className="w-7 h-7" />, value: 98, suffix: '%', label: 'Certification Pass Rate', color: 'text-neon-blue' },
  { icon: <Building2 className="w-7 h-7" />, value: 4, suffix: '', label: 'Corporate Partners', color: 'text-neon-purple' },
