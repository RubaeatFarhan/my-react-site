                ...
                <div className="relative overflow-hidden h-56">
                  ...
                  <div className="absolute left-6 bottom-6">
                    <div className="flex flex-wrap items-center gap-3 mb-3">
                      <span className={`program-pill ${program.team === 'Red Teaming' ? 'team-pill-red' : 'team-pill-blue'}`}>
                        {program.team}
                      </span>
                      {program.badge ? (
                        <div className="program-badge-wrap">
                          <img src={program.badge} alt={`${program.id} badge`} className="program-badge-img" />
                        </div>
                      ) : (
                        <div className="program-badge-wrap placeholder">CCSE badge coming soon</div>
                      )}
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid gap-16 xl:grid-cols-[1.2fr_0.8fr] items-start">
              <div>
                ...
                <div className="mt-14 grid gap-8 sm:grid-cols-2">
                  <div className="bg-zinc-900 border border-white/10 rounded-3xl p-10 shadow-xl shadow-black/20">
          ...
          <div className="mt-20 grid gap-8 lg:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="bg-zinc-900 border border-white/10 rounded-3xl p-10 shadow-xl shadow-black/20">
              ...
              <p className="text-gray-300 leading-8">We continuously improve our content to ensure students get updated and relevant knowledge.</p>
            </div>
            <div className="bg-emerald-500/10 border border-emerald-400/10 rounded-3xl p-10 shadow-xl shadow-black/20">
              <div className="text-white text-xl font-semibold mb-4">Start Your Journey</div>
              <p className="text-gray-300 leading-8 mb-8">If you are serious about learning and building a career, Cyber Cracker Academy is here to guide you step by step.</p>
              <button
                onClick={() => document.getElementById('courses')?.scrollIntoView({ behavior: 'smooth' })}
                className="w-full py-5 rounded-3xl bg-gradient-to-r from-emerald-400 to-cyan-400 text-black font-semibold shadow-lg shadow-emerald-500/20 transition-transform duration-300 hover:-translate-y-1 hover:scale-105"
              >
                Join Today
              </button>
            </div>
