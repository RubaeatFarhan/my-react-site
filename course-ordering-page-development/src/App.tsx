      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-slate-950/80 backdrop-blur-lg">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-sm font-semibold text-white">SkillMaster</span>
              <span className="ml-2 rounded-full bg-indigo-500/20 px-2 py-0.5 text-[10px] font-medium text-indigo-300">BD</span>
            </div>
          </div>
          <div className="flex items-center gap-4 text-xs text-slate-400">
            ...
            <span className="hidden sm:inline-flex items-center gap-1">
              <span className="h-1.5 w-1.5 rounded-full bg-indigo-400" /> SSL Secure
            </span>
          </div>
        </div>
      </header>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              {payment && (
                ...
                >
                  <div className={`rounded-xl border ${payment.border}/30 ${payment.bgLight}/5 p-4`}>
